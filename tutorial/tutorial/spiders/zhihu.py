...
class ZhihuSpider(scrapy.Spider):
    ...
    def parse_user(self, response):
        ...
        yield item
        # yield scrapy.Request(self.follows_url.format(user=result.get('user_token'),include=self.follows_query,limit=20,offset=0),self.parse_follows())
